          ...
          <!-- 使用自定义按钮的话，箭头消失功能无效 -->
            ...
            >
              <v-sheet
                ...
                class="opacity-40"
              >
                <div class="d-flex fill-height align-center" style="flex-direction: column; justify-content: space-around">
                  <div class="text-h2">
                    诗词风采
                  </div>
                  <div class="text-h6">
                  ...
                  <v-btn variant="tonal" rounded="lg" elevation="24" color="#177cb0" size="large" @click="handleClick('shici')">
                    进入游戏
                  </v-btn>
                </div>
              </v-sheet>
            ...
            >
              ...
              >
                <div class="d-flex fill-height align-center" style="flex-direction: column; justify-content: space-around">
                  ...
                  <v-btn variant="tonal" rounded="lg" elevation="24" size="large" color="#177cb0" @click="handleClick('feihua')">
                    进入游戏
                  </v-btn>
                </div>
              </v-sheet>
